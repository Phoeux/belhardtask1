...
urlpatterns = [
    ...
    path('delete_comment/<int:book_id>', views.DeleteComment.as_view(), name='delete_comment'),
    path('update_comment/<int:book_id>', views.UpdateComment.as_view(), name='update_comment'),
]
